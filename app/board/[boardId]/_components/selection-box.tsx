...
import { LayerType, Side, XYWH } from "@/types/canva";
...
export const SelectionBox = memo(
  ({ onResizeHandlePointerDown }: SelectionBoxProps) => {
    const soLayerId = useSelf((me) =>
      me.presence.selection.length === 1 ? me.presence.selection[0] : null
    );
    const isShowingHandles = useStorage(
      (root) => soLayerId && root.layers.get(soLayerId)?.type !== LayerType.Path
    );
        ...
        {isShowingHandles && (
          <>
            ...
            <rect
              ...
              onPointerDown={(e) => {
                e.stopPropagation();
                //TODO RESIZE HANDLER e.stopPropagation();
